...
const books = [
  ...
  {
    id: 'useful-student',
    title: bookData['useful-student'].title,
    author: bookData['useful-student'].author,
    description: 'An honest guide to becoming genuinely useful as a student. Beyond marks, beyond participation — real contribution that matters.',
    rating: bookData['useful-student'].rating,
    pages: bookData['useful-student'].pages,
    coverImage: bookData['useful-student'].coverImage,
    category: 'Self-Help',
    chapters: bookData['useful-student'].chapters.length,
  },
  {
    id: 'procrastinator-universe',
    title: bookData['procrastinator-universe'].title,
    author: bookData['procrastinator-universe'].author,
    description: 'A philosophical journey through the mind of every student who has ever said "I\'ll do it later" and meant it deeply.',
    rating: bookData['procrastinator-universe'].rating,
    pages: bookData['procrastinator-universe'].pages,
    coverImage: bookData['procrastinator-universe'].coverImage,
    category: 'Humor & Philosophy',
    chapters: bookData['procrastinator-universe'].chapters.length,
  },
  {
    id: 'build-first',
    title: bookData['build-first'].title,
    author: bookData['build-first'].author,
    description: 'The unconventional approach to learning any skill. Why building first beats studying first — for students and creators.',
    rating: bookData['build-first'].rating,
    pages: bookData['build-first'].pages,
    coverImage: bookData['build-first'].coverImage,
    category: 'Education & Productivity',
    chapters: bookData['build-first'].chapters.length,
  },
  {
    id: 'desk-life',
    title: bookData['desk-life'].title,
    author: bookData['desk-life'].author,
    description: 'A deeply relatable chronicle of the hours spent at a desk. The thoughts, frustrations, small victories, and existential moments.',
    rating: bookData['desk-life'].rating,
    pages: bookData['desk-life'].pages,
    coverImage: bookData['desk-life'].coverImage,
    category: 'Humor & Life',
    chapters: bookData['desk-life'].chapters.length,
  },
  {
    id: 'offline-productivity',
    title: bookData['offline-productivity'].title,
    author: bookData['offline-productivity'].author,
    description: 'A radical guide to getting things done without internet. Reclaim focus, create without distraction, and discover deep work.',
    rating: bookData['offline-productivity'].rating,
    pages: bookData['offline-productivity'].pages,
    coverImage: bookData['offline-productivity'].coverImage,
    category: 'Productivity',
    chapters: bookData['offline-productivity'].chapters.length,
  },
  {
    id: 'tower-of-memory',
    title: bookData['tower-of-memory'].title,
    author: bookData['tower-of-memory'].author,
    description: 'A unique exploration of memory techniques for students. Building mental architectures that actually stick.',
    rating: bookData['tower-of-memory'].rating,
    pages: bookData['tower-of-memory'].pages,
    coverImage: bookData['tower-of-memory'].coverImage,
    category: 'Learning & Memory',
    chapters: bookData['tower-of-memory'].chapters.length,
  },
  {
    id: 'student-machines',
    title: bookData['student-machines'].title,
    author: bookData['student-machines'].author,
    description: 'A critical look at how education sometimes treats students like machines — and how to stay human within the system.',
    rating: bookData['student-machines'].rating,
    pages: bookData['student-machines'].pages,
    coverImage: bookData['student-machines'].coverImage,
    category: 'Education Critique',
    chapters: bookData['student-machines'].chapters.length,
  },
  {
    id: 'somaiya-files',
    title: bookData['somaiya-files'].title,
    author: bookData['somaiya-files'].author,
    description: 'Untold stories, legendary incidents, and campus folklore from K.J. Somaiya. The stories that never made it to official records.',
    rating: bookData['somaiya-files'].rating,
    pages: bookData['somaiya-files'].pages,
    coverImage: bookData['somaiya-files'].coverImage,
    category: 'Campus Stories',
    chapters: bookData['somaiya-files'].chapters.length,
  },
];
