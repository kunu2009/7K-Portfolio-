...
export default function ServicesMenuCard() {
  return (
    <section id="services" className="relative py-20 overflow-hidden bg-gradient-to-b from-background via-primary/5 to-background section-dots section-border-glow">
      {/* Background Effects */}
