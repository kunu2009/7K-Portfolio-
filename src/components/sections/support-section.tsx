      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="relative aspect-square bg-white rounded-xl p-4 mb-4 shadow-inner">
              <Image
            ...
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                <p className="flex items-start gap-2">
                  ...
                  <span>Open your preferred UPI app (Google Pay, PhonePe, Paytm, etc.)</span>
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-primary mt-0.5">2.</span>
                  <span>Click on "Send Money" or "Pay to UPI ID"</span>
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-primary mt-0.5">3.</span>
                  <span>Enter the UPI ID or scan the QR code</span>
                </p>
                <p className="flex items-start gap-2">
