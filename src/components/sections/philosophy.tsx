...
const PhilosophySection = () => {
  ...
  return (
    <section id="philosophy" className="relative container py-24 sm:py-32 opacity-0 animate-fade-in-up overflow-hidden" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
      {/* Floating decorative images */}
      <DecorationSet set="philosophy" />
