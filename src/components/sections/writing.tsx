    ...
    <section id="writing" className="container py-24 sm:py-32 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        {writings.map((writing) => (
          <Card key={writing.title} className="overflow-hidden group border shadow-md hover:shadow-xl hover:scale-[1.03] transition-all duration-300 ease-in-out flex flex-col sm:flex-row">
